...
#' Using \code{long_to_matrix} can be converted to \code{example_proteome_matrix}
#'
#' @format A data frame with 85278 rows and 3 variables:
#' \describe{
...
#' \code{long_to_matrix}
#'
#' @format A matrix with 366 rows and 233 columns:
#' 
#' @source PRIDE ID will be added upon the publication of the dataset
