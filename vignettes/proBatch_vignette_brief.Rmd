...
knitr::include_graphics("gallery_.png")
```
...
The contribution of each technical and biological factor can be quantified and illustrated with PVCA 
(principal variance component analysis). Additionally, it is useful to diagnose batch effects on feature level
for example, by plotting several peptides of the same protein. 
