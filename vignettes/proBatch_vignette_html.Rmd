...
```{r plot_heatmap, fig.show='hold', fig.width=6, fig.height=8}
...
```{r, include = TRUE, fig.align = "center", echo=FALSE, out.width = '75%'}
...
```{r corr_samples_heatmap, fig.show='hold', fig.height=3.5, fig.width=4.5}
# Plot the heatmap 
...
spectrometry).
```{r corr_samples_distrib, fig.show='hold', fig.width=4, fig.height=4}
...
```{r correlation_of_peptides, fig.show='hold',fig.width=4, fig.height=3.2}
