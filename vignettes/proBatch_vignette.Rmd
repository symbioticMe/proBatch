---
title: "proBatch"
author: "Jelena Čuklina, Chloe H. Lee, Patrick Pedrioli and Ruedi Aebersold"
...
In this vignette, we use functions from `dplyr`, `tibble` and other `tidyverse` package family to transform some data frames
```{r load_packages}
require(dplyr)
require(tibble)
require(ggplot2)
