...
plot_single_feature (feature_name = "10231_QDVDVWLWQQEGSSK_2", loess_fit_df, 
          example_sample_annotation, plot_title = "Loess Fitted", color_by_col = NULL)
plot_single_feature (feature_name = "10231_QDVDVWLWQQEGSSK_2", combat_df, 
...
plot_sample_corr_heatmap(quantile_normalized_matrix, samples_to_plot = replicate_filenames, 
                         flavor = 'pheatmap', 
                         plot_title = 'Quantile Normalized correlation matrix of selected replicated samples', 
