...
loess_fit_matrix <- loess_fit$corrected_df
```
...
plot_single_feature(feature_name = "10231_QDVDVWLWQQEGSSK_2", df_long = peptide_median_df, 
            sample_annotation = example_sample_annotation, measure_col = 'Intensity_normalized',
...
comBat_df <- correct_with_ComBat(loess_fit_df, example_sample_annotation)
```
